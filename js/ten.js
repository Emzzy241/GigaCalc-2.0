                                            ...
                                            $(".check9").click(() => {
                                                ...
                                                $(".check10").click(() => {
                                                    ...
                                                    // For 3 unit courses now
                                                        ...
                                                        let mytotalGPA = oneCoursegpa + twoCoursegpa + threeCoursegpa + fourthCoursegpa + fifthCoursegpa + sixthCoursegpa + seventhCoursegpa + eightCoursegpa + ninthCoursegpa + tenthCoursegpa;
                                                        console.log(mytotalGPA);

                                                        // let mytotalCoursesUnit = courseUnit1 + courseUnit2 + courseUnit3 + courseUnit4 + courseUnit5 + courseUnit6 + courseUnit7;
                                                        let mytotalCoursesUnit = courseUnit1 + courseUnit2 + courseUnit3 + courseUnit4 + courseUnit5 + courseUnit6 + courseUnit7 + courseUnit8 + courseUnit9 + courseUnit10;
                                                        console.log(mytotalCoursesUnit);
                                                        ...
                                                        $("#finalResult").click(() => {
                                                            ...
                                                            let mytotalGPAPerCourse = oneCoursegpa + twoCoursegpa + threeCoursegpa + fourthCoursegpa + fifthCoursegpa + sixthCoursegpa + seventhCoursegpa + eightCoursegpa + ninthCoursegpa + tenthCoursegpa;
                                                            let mytotalCoursesUnit = courseUnit1 + courseUnit2 + courseUnit3 + courseUnit4 + courseUnit5 + courseUnit6 + courseUnit7 + courseUnit8 + courseUnit9 + courseUnit10;
